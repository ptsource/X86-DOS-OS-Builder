...
This use case allows you to have a CP/M-80 System using ALIAS and [ZRUN](https://ko-fi.com/s/14d98aea8d). The example is in the ZRUNCPM.IMG and it builds under the folder DISTROC.
